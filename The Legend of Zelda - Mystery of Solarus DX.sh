#!/bin/bash
# PORTMASTER: zelda-mysteryofsolarusdx.zip, The Legend of Zelda - Mystery of Solarus DX.sh
...
# Set variables
GAMEDIR="/$directory/ports/zelda-mysteryofsolarusdx"
